...
static const char* id_scope = "0ne00054541";
...
int prov_dev_client_ll_sample_run()
{
    ...
    bool traceOn = true; //JLR

    printf("JLR-IoTHub_Init call\n");
    (void)IoTHub_Init();
    printf("JLR-prov_dev_security_init call\n");
    ...
    {
        printf("JLR-Prov_Device_LL_Created\n");
        ...
        printf("JLR-TRUSTED_CERT_IN_SAMPLES\n");
        ...
        {
            printf("JLR-Prov_Device_LL_Register_Device\n");
            do
            {
                //printf("JLR-Prov_Device_LL_DoWork call 1 \n");
                Prov_Device_LL_DoWork(handle);
                //printf("JLR-Prov_Device_LL_DoWork call 2 \n");
    ...
    {
        printf("JLR-DEVICE REGISTRATION COMPLETE\n");
